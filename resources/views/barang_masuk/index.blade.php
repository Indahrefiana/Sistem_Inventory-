...
<head>
    <meta charset="UTF-8">
    <title>Barang Masuk - Dapoer Tipes</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Inter', sans-serif; }
        ...
        .profile-icon {
            ...
            color: var(--primary); border: 1px solid #e2e8f0;
        }
        ...
        .dropdown-item {
            ...
            padding: 10px 16px; color: var(--text-dark);
        ...
        .btn-submit { background: var(--primary); color: white; border: none; padding: 12px 25px; border-radius: 8px; cursor: pointer; font-weight: bold; transition: 0.2s; }
        ...
        td { padding: 16px 20px; text-align: left; border-bottom: 1px solid #f1f5f9; color: #334155; font-size: 14px; }
...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="/barang-masuk" class="active"><i class="fas fa-arrow-circle-down"></i> &nbsp; Barang Masuk</a>
    ...
    <div class="main">
        ...
        <div class="content-area">
            <div class="card">
                <h3 style="margin-bottom: 15px;">Tambah Barang Masuk</h3>
                <form action="{{ route('barang-masuk.store') }}" method="POST">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="jumlah_masuk" placeholder="Contoh: 50" required>
                        </div>
                    </div>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-success">+ {{ number_format($item->jumlah_masuk, 0, ',', '.') }}</td>
                            <td><span style="background: #f1f5f9; padding: 4px 8px; border-radius: 4px; font-size: 12px;">Stok Masuk</span></td>
                            <td>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            <h3 style="margin-bottom: 20px;">Edit Barang Masuk</h3>
            <form id="editForm" method="POST">
                ...
                <div class="input-group">
                    <label>Jumlah</label>
                    <input type="number" name="jumlah_masuk" id="edit_jumlah_masuk">
                </div><br>
                <button type="submit" class="btn-submit" style="width: 100%;">Update Data</button>
    ...
    <script>
        ...
        /* SCRIPT UNTUK EDIT MODAL & CLOSE DROPDOWN */
        function openEditModal(item) {
            document.getElementById('editForm').action = '/barang-masuk/' + item.id;
            document.getElementById('edit_barang_id').value = item.barang_id;
            document.getElementById('edit_jumlah_masuk').value = item.jumlah_masuk;
